  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="text-center text-white">
            ...
            <p className="text-xl mb-6">
              Join our community of travel enthusiasts to share and document
              your journeys.
            </p>
          </div>
        </div>
      ...
      <div className="w-full py-16 px-8 text-center">
        ...
        <p className="text-lg text-gray-700 mb-6 max-w-4xl mx-auto">
          Meeting new people, learning new languages, and immersing ourselves in
          diverse traditions enriches our understanding of the world. It
          challenges our perspectives, enhances our creativity, and fosters
          personal growth. Travel is not just about the destinations; it's about
          the journey, the memories we create, and the stories we bring back
          with us.
        </p>
        <p className="text-lg text-gray-700 mb-6 max-w-4xl mx-auto">
          Through our travel blog, we aim to inspire your next adventure,
          whether you're exploring far-flung destinations or discovering hidden
          gems in your own backyard. Let’s embrace the unknown, seek out the
          unexplored, and make every moment count.
        </p>
      </div>
    </div>
  );
