  ...
  const blogs = [
    {
      ...
      description:
        "Discover the beauty of the Himalayas with breathtaking views, thrilling treks, and serene nature.",
      image: h1,
    },
    {
      id: 2,
      ...
      place: "Tokyo, Japan",
      description:
        "Experience the vibrant city life, explore traditional temples, and enjoy the unique cuisine of Tokyo.",
      image: home1,
    },
    {
      id: 3,
      ...
      description:
        "Soak up the sun on Bali’s pristine beaches, enjoy water sports, and discover local culture.",
      image: t1,
    },
  ];
